...
class BottomNavToAccount extends StatefulWidget {
  final String id;
  final String serial;
  final String fname;
  final String lname;
  ...
  State<StatefulWidget> createState() {
    return bottomNavtoAccount();
  }
}

class bottomNavtoAccount extends State<BottomNavToAccount> {
  String id = '';
  String serial = '';
  String fname = '';
  String lname = '';
